...
import galimullin.danis.tacocloud.model.IngredientRef;
...
public class JdbcOrderRepository implements OrderRepository {
    ...
    private void saveIngredientRefs(long tacoId, @NotNull @Size(min = 1, message = "You must choose at least 1 ingredient") List<IngredientRef> ingredientRefs) {
        int key = 0;
